...
export interface AddEditServiceModalProps {
  onSave: (service: Service) => void;
  onClose?: () => void;
}

const AddEditServiceModal = forwardRef(
  (props: AddEditServiceModalProps, ref) => {
    ...
    // useImperativeHandle để component cha có thể gọi open/close
                ...
                {({ getFieldValue }) => {
                    ...
                    return (
                      <div className='grid grid-cols-2 gap-2 h-[90px]'>
                        ...
                        <Form.Item
                          ...
                          name='to_price'
                          rules={[
                            { required: true, message: 'Enter to price!' },
                          ]}
                        >
                          <Input
                            className='h-[31px] w-[111px] text-sm'
                  ...
                  return (
                    <Form.Item
                      ...
                      name='fixed_price'
                      rules={[
                        { required: true, message: 'Enter fixed price!' },
                      ]}
                    >
                      <Input
                        className='h-[31px] w-[229px] text-sm'
